...
8.  Remove the sidebar on the right hand side of the first documentation badge.  In the website/siteConfig.js file, delete the line "onPageNav: 'separate'" (and the comment above).
9.  Enable the search engine in this app.  More details are provided at https://docusaurus.io/docs/en/search.html.
